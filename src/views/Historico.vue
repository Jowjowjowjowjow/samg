    ...
    <v-container fluid class="historico">
        ...
        <v-btn :disabled="!naoEquivalentes.length" text
            ...
            <v-list class="d-flex flex-row flex-wrap">
                <v-list-item v-for="legenda in legendas" :key="legenda.eixo" class="d-flex flex-row align-center">
...
const EIXO_COR = [
    ...
    { eixo: "Aprovado / Aprovado sem nota", cor: "green" },
    { eixo: "Dispensa com nota / Dispensa sem nota", cor: "yellow" },
    { eixo: "Reprovado sem nota", cor: "orange" },
    { eixo: "Reprovado por nota / Reprovado por falta", cor: "red" },
]
